# -*- coding: utf-8 -*-
"""
Created on Fri Feb 14 11:35:39 2020

@author: mourad
"""

'''*******************************
First-visit Epsilon-Greedy Monte Carlo control  w/o exploring-Starts 
*******************************'''
...
def generateEpisode_3(Policy,t):
    ...
    while list(initState) not in terminationStates and robot_is_stuck== False and len(episode)<100 :
        ...
        if p < (1 - (eps/t)):
            ...
            nextAction = random.choice(actions)  #here the policy is random
...
def play_game_3(Policy,t):
    episode= generateEpisode_3(Policy,t)
...
for it in tqdm(range(numIterations)):
  ...
  states_actions_returns = play_game_3(Policy,t)
